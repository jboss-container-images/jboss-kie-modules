...
[here](https://github.com/jboss-container-images/rhpam-7-openshift-image/blob/7.5.x/kieserver/image.yaml#L179) the
jboss-kie-module repo is used and in this [line](https://github.com/jboss-container-images/rhpam-7-openshift-image/blob/7.5.x/kieserver/image.yaml#L222)
...
To run the behave tests for the specific image i.e. [kie-server image](https://github.com/jboss-container-images/rhpam-7-openshift-image/tree/7.5.x/kieserver),
...
Feature: RHPAM Smart Router configuration tests # features/jboss-kie-modules.git-7.5.x/rhpam/smartrouter/rhpam-smartrouter.feature:2

  Scenario: Check if image version and release is printed on boot                          # features/jboss-kie-modules.git-7.5.x/rhpam/smartrouter/rhpam-smartrouter.feature:5
...
Our tests are driven by annotations, that means each feature or scenario are annotated with the, i.e. [image name](https://github.com/jboss-container-images/jboss-kie-modules/blob/7.5.x/tests/features/common/kie-kieserver-common.feature#L1)
...
[image.yaml](https://github.com/jboss-container-images/rhpam-7-openshift-image/blob/7.5.x/kieserver/image.yaml#L3-L5) file descriptor.
