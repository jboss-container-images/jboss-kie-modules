#!/bin/sh
# Openshift RHDM Employee Rostering Business Optimizer launch script
...
JBOSS_BPMSUITE_ARGS="${JBOSS_BPMSUITE_ARGS} -Doptashift.rostering.persistence.datasource=${OPTASHIFT_ROSTERING_PERSISTENCE_DATASOURCE} -Doptashift.rostering.persistence.dialect=${OPTASHIFT_ROSTERING_PERSISTENCE_DIALECT}"
