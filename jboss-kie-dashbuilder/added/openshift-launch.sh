#!/bin/sh
# Openshift JBoss KIE - Standalone Dashbuilder launch script
...
CONFIGURE_SCRIPTS=(
    ...
    $JBOSS_HOME/bin/launch/jboss-kie-dashbuilder.sh
...
D_OPTS="${JBOSS_KIE_DASHBUILDER_ARGS}"
D_DLM=" -D"
D_STR=" ${D_OPTS}${D_DLM}"
D_ARR=()
while [[ $D_STR ]]; do
...
exec $JBOSS_HOME/bin/standalone.sh -c standalone-openshift.xml -bmanagement 127.0.0.1 \
