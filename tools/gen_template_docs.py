...
LINKS = {"rhdm70-kieserver-openshift:1.0": "../../../kieserver/image.yaml[`rhdm-7/rhdm70-kieserver-openshift`]",
          "rhpam70-kieserver-openshift:${IMAGE_STREAM_TAG}": "../../../kieserver/image.yaml[`rhpam-7/rhpam70-kieserver-openshift`]",}
      ...
      if table == "image":
         ...
         if container.get("readinessProbe"):
            if 'httpGet' in container["readinessProbe"]:
                text += ("\n." + deployment + "\n----\n" \
                         + "".join("Http Get on http://localhost:" + str(container["readinessProbe"]["httpGet"]["port"])) \
