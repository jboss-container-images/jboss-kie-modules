...
public class PersistentTimersTestBase extends KieServerTestBase {
    ...
    @RunAsClient
    @InSequence(3)
    public void startProcesses() throws UnsupportedEncodingException, NoSuchAlgorithmException, MalformedURLException {
     ...
     * @throws NoSuchAlgorithmException     if the algorithm used is not found
     */
    private Object getVariable(long processId) throws MalformedURLException, UnsupportedEncodingException, NoSuchAlgorithmException {
    ...
    /**
     * In the KieServer 63 the containers are converted to a MD5 hash in the following patter: CONTAINER_ID=G:A:V
     *
