...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-container-images}/jboss-processserver-6-openshift-image/${template.branch:master}/templates/processserver64-amq-mysql-persistent-s2i.json", parameters = {
        @TemplateParameter(name = "KIE_SERVER_USER", value = "${kie.username:kieserver}"),
        @TemplateParameter(name = "KIE_SERVER_PASSWORD", value = "${kie.password:Redhat@123}"),
        @TemplateParameter(name = "MYSQL_USER", value = "redhat"),
        @TemplateParameter(name = "MYSQL_PASSWORD", value = "redhat123"),
...
public class ProcessServerAmqMySqlPersistentTest extends LibraryProcessAmqTestBase {

    @Deployment
    public static WebArchive getDeployment() throws Exception {
        WebArchive war = LibraryProcessAmqTestBase.getDeployment();
        war.addClass(ProcessServerAmqMySqlPersistentTest.class);
        return war;
    }
