...
@XmlType(name = "suggestionRequest", namespace = "urn:openshift-quickstarts:processserver-library:1.4", propOrder = {
    "keyword"
})
@XmlRootElement(name = "suggestionRequest", namespace = "urn:openshift-quickstarts:processserver-library:1.4")
