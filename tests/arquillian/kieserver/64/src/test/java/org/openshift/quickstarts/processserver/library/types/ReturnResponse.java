...
@XmlType(name = "returnResponse", namespace = "urn:openshift-quickstarts:processserver-library:1.4", propOrder = {
    "acknowledged"
})
@XmlRootElement(name = "returnResponse", namespace = "urn:openshift-quickstarts:processserver-library:1.4")
