...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-container-images}/jboss-processserver-6-openshift-image/${template.branch:master}/templates/processserver64-mysql-persistent-s2i.json",
        parameters = {
...
public class ProcessServerMySqlPersistentTest extends LibraryProcessTestBase {
