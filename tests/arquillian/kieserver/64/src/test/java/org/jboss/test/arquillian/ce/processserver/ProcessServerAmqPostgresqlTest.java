...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-container-images}/jboss-processserver-6-openshift-image/${template.branch:master}/templates/processserver64-amq-postgresql-s2i.json", parameters = {
...
public class ProcessServerAmqPostgresqlTest extends LibraryProcessAmqTestBase {
    ...
    public static WebArchive getDeployment() throws Exception {
        ...
        war.addClass(ProcessServerAmqPostgresqlTest.class);
        return war;
    }
