...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-container-images}/jboss-processserver-6-openshift-image/${template.branch:master}/templates/processserver64-amq-postgresql-persistent-s2i.json", parameters = {
...
public class ProcessServerAmqPostgresqlPersistentTest extends LibraryProcessAmqTestBase {

    @Deployment
    public static WebArchive getDeployment() throws Exception {
        WebArchive war = LibraryProcessAmqTestBase.getDeployment();
        war.addClass(ProcessServerAmqPostgresqlPersistentTest.class);
        return war;
    }
