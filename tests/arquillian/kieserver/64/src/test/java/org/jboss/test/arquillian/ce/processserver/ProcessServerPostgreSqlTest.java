...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-container-images}/jboss-processserver-6-openshift-image/${template.branch:master}/templates/processserver64-postgresql-s2i.json",
        parameters = {
...
public class ProcessServerPostgreSqlTest extends LibraryProcessTestBase {
